...
- [ ] **Phase 1: Crypto Core + HTTP API** - Establish round-trip encryption/decryption, BIP invariants, memory safety, and stable axum endpoints
...
|-------|----------------|--------|-----------|
| 1. Crypto Core + HTTP API | 0/? | Not started | - |
